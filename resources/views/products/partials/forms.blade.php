...
@if (Request::get('action') == 'create')
    ...
    <div class="row">
        <div class="col-md-6">{!! FormField::price('cash_price', ['label' => __('product.cash_price'), 'required' => true , 'type'=>'number']) !!}</div>
        <div class="col-md-6">{!! FormField::price('credit_price', ['label' => __('product.credit_price'), 'type'=>'number']) !!}</div>
    </div>
    {!! FormField::select('unit_id', $unit->pluck('name','id'), ['label' => __('product.unit'), 'required' => true]) !!}
    {!! FormField::text('stok', ['label' => __('product.stok'), 'required' => true , 'type'=>'number']) !!}
